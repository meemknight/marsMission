...
HX_LOCAL_STACK_FRAME(_hx_pos_39f5eab4124248fe_37_stdin,"Sys","stdin",0x03b9a107,"Sys.stdin","/usr/local/lib/haxe/std/cpp/_std/Sys.hx",37,0xd23c22f3)
...
bool Sys_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Input Sys_obj::_hx_stdin(){
            	HX_GC_STACKFRAME(&_hx_pos_39f5eab4124248fe_37_stdin)
